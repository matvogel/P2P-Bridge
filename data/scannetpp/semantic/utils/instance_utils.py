...
def get_label_info(semantic_class_list, instance_class_list):
    ...
    label_info.ignore_classes = [
        i for i in range(len(label_info.all_class_labels)) if label_info.all_class_labels[i] not in instance_class_list
    ]
    ...
    label_info.class_labels = [
        label_info.all_class_labels[i] for i in label_info.all_class_ids if i not in label_info.ignore_classes
    ]
...
def read_instance_prediction_file(filename, pred_path):
    ...
    for line in lines:
        ...
        assert (
            os.path.commonprefix([mask_file, abs_pred_path]) == abs_pred_path

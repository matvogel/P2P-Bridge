...
class PointCloudCenterAndNormalize(object):
    def __init__(self, centering=True, normalize=True, gravity_dim=2, append_xyz=False, **kwargs):
...
class ChromaticNormalize(object):
    def __init__(
        self, color_mean=[0.5136457, 0.49523646, 0.44921124], color_std=[0.18308958, 0.18415008, 0.19252081], **kwargs
    ):
...
class Cutmix:
    ...
    def __init__(self, cutmix_alpha=0.3, prob=1.0, label_smoothing=0.1, num_classes=1000):

...
from third_party.PointNeXt.openpoints.cpp.chamfer_dist import ChamferDistanceL1
from third_party.PointNeXt.openpoints.models.build import MODELS
from third_party.PointNeXt.openpoints.models.layers import create_norm
from third_party.PointNeXt.openpoints.models.layers.attention import Block
...
class MaskedPointViT(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.decoder_pos_embed = nn.Sequential(nn.Linear(3, 128), nn.GELU(), nn.Linear(128, decoder_embed_dim))

...
from third_party.PointNeXt.openpoints.transforms import build_transforms_from_cfg
...
class MVFC(nn.Module):
    ...
    def __init__(self, num_views, in_features, out_features, dropout):
        ...
        self.model = nn.Sequential(
            ...
            nn.Dropout(dropout),
            nn.Flatten(),
            nn.Linear(in_features=in_features * self.num_views, out_features=in_features),
...
class MVModel(nn.Module):
    ...
    def get_img_layers(backbone, channels):
        ...
        from .resnet import BasicBlock, _resnet
        ...
        img_layers = [
            ...
            nn.BatchNorm2d(channels, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True),

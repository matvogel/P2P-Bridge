...
def load_data_partseg(partition, DATA_DIR):
    ...
    if partition == "trainval":
        file = glob.glob(os.path.join(DATA_DIR, "*train*.h5")) + glob.glob(os.path.join(DATA_DIR, "*val*.h5"))
    else:
...
class ShapeNetPartNormal(Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.meta = {}
        with open(
            os.path.join(self.root, "train_test_split", "shuffled_train_file_list.json"),
            "r",
        ) as f:
